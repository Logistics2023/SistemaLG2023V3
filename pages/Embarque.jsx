...
import style from '../styles/Embarque.module.css'
        ...
        <Layout>
            <div className={style.container}>
                <form className={style.form}>
                    ...
                    <div className={style.subtitle}>INSTRUCCIONES DE EMBARQUE</div>
                    ...
                    <div className={style.subtitle}>EMBARCADOR / EXPORTADOR / NOMBRE COMPLETO / DIRECCIÓN </div>

                    <div className={`${style.inputs}`}>
                        <input type="text" name={`DETALLEADICIONAL`} placeholder="NOMBRE" />
                        <input type="number" name={`COSTOUNITARIO`} placeholder="DIRECCIÓN" />
                        <input type="number" name={`CANTIDAD`} placeholder="TAX ID" />
                        <input type="number" placeholder="TELEFONO" />
                        <input type="number" placeholder="EMAIL" />
                    </div>
                    <div className={style.subtitle}>CONSIGNATARIO / IMPORTADOR / NOMBRE COMPLETO / DIRECCIÓN </div>
                    ...
                    <div className={style.subtitle}>NOTIFICA A:</div>
                    ...
                    <div className={style.subtitle}>DOCUMENTOS INCLUIDOS CON EL ENVIO <span className={style.counterPluss} onClick={() => handlerCounterFour('pluss')}>+</span> <span className={style.counterLess} onClick={() => handlerCounterFour('less')}>-</span></div>
                    ...
                    <div className={style.subtitle}>INSTRUCCIONES DOMESTICAS/ TAMBIEN NOTIFICAR / AGENTE EN LA PUERTA DE DESCARGA </div>
                    ...
                    <div className={style.items}>
                        ...
                        <div>
                            ...
                            <input type="text" name={"DESCRIPCIÓN DE LA CARGA"} onChange={handleEventChange} />
                        </div>
                        <div>
                            <label htmlFor="">SUBPARTIDA / CODIGO ARMONIZADO</label>
                            <input type="text" name={"SUBPARTIDA / CODIGO ARMONIZADO"} onChange={handleEventChange} />
                        </div>
                        <div>
                            <label htmlFor="">PESO BRUTO POR PAQUETE</label>
                            <input type="text" name={"PESO BRUTO POR PAQUETE"} onChange={handleEventChange} />
                        </div>

                        <div>
                            <label htmlFor="">CANTIDAD DE PAQUETES</label>
                            <input type="text" name={"CANTIDAD DE PAQUETES"} onChange={handleEventChange} />
                        </div>
                        <div>
                            <label htmlFor="">PESO BRUTO TOTAL</label>
                            <input type="text" name={"PESO BRUTO TOTAL"} onChange={handleEventChange} />
                        </div>

                        <div>
                            <label htmlFor="">DIMENCIÓN POR PAQUETE (Largo x ancho x alto)(Cm)</label>
                            <input type="text" name={"DIMENCIÓN POR PAQUETE"} onChange={handleEventChange} />
                        </div>
                        <div>
                            <label htmlFor="">VOLUMEN TOTAL (M3)</label>
                            <input type="text" name={"VOLUMEN TOTAL"} onChange={handleEventChange} />
                        </div>
                        <div>
                            <label htmlFor="">VALOR DE LA CARGA EN USO</label>
                            <input type="text" name={"VALOR DE LA CARGA EN USO"} onChange={handleEventChange} />
                        </div>

                        <div>
                            <label htmlFor="">SELLOS Y NUMEROS // CONTAINER // SEAL No.</label>
                            <input type="text" name={"SELLOS Y NUMEROS // CONTAINER // SEAL No."} onChange={handleEventChange} />
                        </div>
                        <div>
                            <label htmlFor="">REFERENCIA DEL EXPORTADOR</label>
                            <input type="text" name={"REFERENCIA DEL EXPORTADOR"} onChange={handleEventChange} />
                        </div>
                    </div>
                    <div className={style.subtitle}>REMARKS / INSTRUCCIONES ESPECIALES <span className={style.counterPluss} onClick={() => handlerCounterFive('pluss')}>+</span> <span className={style.counterLess} onClick={() => handlerCounterFive('less')}>-</span></div>
                    {
                        notas.map((i, index) => {
                            return (
                    ...
                    <div className={style.subtitle}>FAVOR CONFIRMAR QUE TODOS LOS DATOS SEAN CORRECTOS ANTES DE ENVIAR</div>
                    <br />
                    <div className={style.items}>
